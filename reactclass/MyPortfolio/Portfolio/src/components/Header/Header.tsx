    ...
    return (
        <AnimatePresence>
            {showHeader && (
                ...
                >
                    <div
                        className="border border-gray-100 dark:border-gray-900 backdrop-blur-xl bg-white/70 dark:bg-gray-900/70
                        ...
                        <nav className="hidden md:flex flex-1 justify-center">
                            <ul className="flex space-x-6">
                                {navItems.map((item) => (
                                    <motion.li
                                        key={item.name}
                                        className="relative group text-sm font-medium text-gray-800 
